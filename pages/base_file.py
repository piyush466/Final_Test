...
from Utilities.generates_log import LogGen
...
class Base:
    ...
    def assertion(self, actual_value, expected_value):
        try:
            ...
            self.logs.error(f"Assertion failed: {actual_value} == {expected_value}, {E}")
            raise
    ...
    def take_screenshot(self):
        ...
        self.driver.save_screenshot(f"../screenshot/{screenshot_name}")
        self.logs.error(f"Your test is fail please check screenshot:- {screenshot_name}")
